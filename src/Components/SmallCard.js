...
const SmallCard = () => {
  return (
    <div className='smallCard-containeer'>
      ...
      <div className='smallcard-img1 bg' style={{backgroundImage:`url(${facebbok})`}}>
  
      </div> <div className='smallcard-img1 bg' style={{backgroundImage:`url(${twitter})`}}>
  
  </div> <div className='smallcard-img1 bg' style={{backgroundImage:`url(${youtube})`}}>
  
  </div>
      <div className='smallcard-img1 bg' style={{backgroundImage:`url(${instagram1})`}}>
